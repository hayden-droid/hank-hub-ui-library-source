...
Btn_GetKey.MouseButton1Click:Connect(function()
    ...
    Bnotify("Hank HUB","Copy invite link by click Copy button",15,"Copy","Cancel",CopyInvite,Canceled)
end)
...
Btn_Verify.MouseButton1Click:Connect(function()
    ...
    if TextBox_Login.Text == _G.Key then
        notify("Hank HUB","Verifying..",5)
        wait(5)
        notify("Hank HUB","Correct key!",2)
        ...
        notify("Hank HUB","Verifying..",5)
        wait(5)
        Bnotify("Hank HUB","The key is incorrect! Please join our discord server to get new key",15,"Copy invite","Cancel",CopyInvite,Canceled)
    end
end)
